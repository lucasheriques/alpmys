...
public class IngressoFragment extends Fragment {
    ...
    @SuppressLint("ValidFragment")
    public IngressoFragment(Evento evento) {
       this.evento=evento;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        listview=(ListView) view.findViewById(R.id.listviewIngressos);
        ArrayList<TipoIngresso> arrayList=new ArrayList<TipoIngresso>();
        TipoIngresso tipoIngresso=new TipoIngresso();
        tipoIngresso.setTipo("Inteira");
