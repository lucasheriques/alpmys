...
public class Organizador {
    ...
    @SerializedName("organizadorDesde")
    @Expose
    private String organizadorDesde;
    @SerializedName("nome")
    @Expose
    private String nome;
    ...
    public String getOrganizadorDesde() {
        return organizadorDesde;
    }

    public void setOrganizadorDesde(String organizadorDesde) {
        this.organizadorDesde = organizadorDesde;
    }
